...
**📖 Detailed Instructions**: See [ADD_POSTGRES_DB.md](./ADD_POSTGRES_DB.md) for step-by-step guide with screenshots and troubleshooting.
...
- Monitor resource usage in Railway Dashboard → Metrics
